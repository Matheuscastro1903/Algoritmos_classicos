def divisivel_3(n, lista_comparativa):

    if n == 3 or n in lista_comparativa:
        return "É divisível"
    if n < 3 and n != 0:
        ...
        return divisivel_3(soma,lista_comparativa)


lista_umalgarismo = [0, 6, 9]
print(divisivel_3(543, lista_umalgarismo))
